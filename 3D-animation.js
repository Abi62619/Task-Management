...
const STORAGE_KEY = `animation-tasks:${animationName}`;
...
const confirmedBtn = document.querySelector(".animationConfirmed");
const cancelledBtn = document.querySelector(".animationCancel");

// ---- EVENTS ----
document
  .getElementById("animationTaskForm")
