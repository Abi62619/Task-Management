// ---- CONFIG ----
const dissertationName = "Dissertation";
const STORAGE_KEY = `dissertation-tasks:${dissertationName}`;
...
const confirmedBtn = document.querySelector(".dissertationConfirmed");
const cancelledBtn = document.querySelector(".dissertationCancel");

// ---- EVENTS ----
document
  .getElementById("dissertationTaskForm")
