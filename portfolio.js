// ---- CONFIG ----
const portfolioName = "MyPortfolio";
const STORAGE_KEY = `portfolio-tasks:${portfolioName}`;
...
const confirmedBtn = document.querySelector(".portfolioConfirmed");
const cancelledBtn = document.querySelector(".portfolioCancel");

// ---- EVENTS ----
document
  .getElementById("portfolioTaskForm")
